...
// d3d透視正式.cpp : 定義應用程式的類別行為。
//

#include "stdafx.h"
#include "d3d透視正式.h"
#include "d3d透視正式Dlg.h"
#include "game.h"
...
BEGIN_MESSAGE_MAP(Cd3d透視正式App, CWinApp)
